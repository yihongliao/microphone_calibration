...
alpha = 0.01  # smaller value allows noise floor to change faster
threshold = 0.1
...
signal_fp = os.path.join(
    os.path.dirname(__file__), "Chirp_Sound2_3s.wav"
)
noise_fp = os.path.join(
    os.path.dirname(__file__), "ambient_1.wav"
)
...
processed_audio = scnr.apply_iterative_wiener(noisy_signal, frame_len=512,
